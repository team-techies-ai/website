...
//             Empowering innovation through cutting-edge technology solutions. Our mission is to bridge the gap between
//             imagination and reality in the digital realm.
//           </p>
//           <h3 className="text-xl text-center mt-6 font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#817e7e] via-white to-[#817e7e]">
//             Our Services
//           </h3>
//           <ul className="text-gray-300 text-justify text-lg md:text-xl mt-2 list-disc list-inside">
...
//               onChange={handleChange}
//               required
//               className="w-full p-4 bg-[#0b0314] text-white border rounded-md outline-none relative z-10 placeholder-gray-500 resize-vertical"
//             />
//           </div>
//           <button
//             type="submit"
