...
const Contact = () => {
  ...
  const handleTimeChange = (time) => {
    const formattedTime = time ? time.toTimeString().split(" ")[0] : "" // Format: HH:MM:SS
    setFormData((prevState) => ({
      ...prevState,
      schedule: {
        ...prevState.schedule,
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full lg:w-1/2">
            ...
            <div className="flex gap-4">
              <div className="relative flex-1 w-full">
                <div className="absolute inset-0 rounded-md p-[1px]"></div>
                <DatePicker
                  selected={formData.schedule.date ? new Date(formData.schedule.date) : null}
              ...
              <div className="relative flex ">
                <div className="absolute inset-0 rounded-md p-[1px] "></div>
                <DatePicker
                  selected={formData.schedule.time ? new Date(`1970-01-01T${formData.schedule.time}`) : null}
