...
const Glass = ({head, para}) => {
    return (
      <div className="group w-[274px] h-[222px] backdrop-blur-sm text-white bg-opacity-50 bg-[#0b0314] rounded-lg p-4 text-center items-center relative overflow-hidden">
